      ...
      <div className="flex flex-col bg-light  shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
        ...
        <div className="relative mt-10 h-px bg-light">
          <div className="absolute left-0 top-0 flex justify-start w-full -mt-2">
            <span className="bg-light px-4 text-xs text-gray-500 uppercase">Or Login With Username</span>
          </div>
        </div>
        <div className="mt-10">
          <form action="#">
            ...
            <div className="flex w-full">
              <button type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-dark/90 hover:bg-dark rounded py-2 w-full transition duration-150 ease-in">

      ...
      <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
        ...
        <div className="relative mt-10 h-px bg-gray-300">
          <div className="absolute left-0 top-0 flex justify-start w-full -mt-2">
            <span className="bg-white px-4 text-xs text-gray-500 uppercase">Or Login With Username</span>
          </div>
        </div>
        <div className="mt-10">
          <form action="#">
            ...
            <div className="flex items-center mb-6 -mt-4">
              <div className="flex ml-auto">
                <button className="inline-flex text-xs sm:text-sm text-blue-500 hover:text-blue-700" type="button">
        ...
        <div className="flex justify-center items-center mt-6">
          <button className="inline-flex items-center font-bold text-blue-500 hover:text-blue-700 text-xs text-center" type="button">
            <span>
              <svg className="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
